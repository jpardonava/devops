...
#Configuracion de red del master
...
#Configuracion de red del worker
...
#Configuracion de red del nfs

resource "azurerm_public_ip" "nfs_ip" {
  name                = "nfs_ip"
  location            = azurerm_resource_group.rg.location
  resource_group_name = azurerm_resource_group.rg.name
  allocation_method   = "Dynamic"
...
resource "azurerm_network_interface" "nic_nfs" {
  ...
  ip_configuration {
    ...
    public_ip_address_id          = azurerm_public_ip.nfs_ip.id
  }
}
